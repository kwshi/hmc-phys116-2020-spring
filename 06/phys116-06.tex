...
\begin{exercise}[Townsend 5.3 (5 pts)]
  Express the total-spin \(s=0\) state of two spin-\(\frac 1 2\) particles given in (5.31) in terms of the states \(\kvv +-\) and \(\kvv -+\), where for a single spin-\(\frac 1 2\) particle
  \begin{align*}
    \kv +n
